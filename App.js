...
export default function App() {
  ...
  return (
    ...
    <View className='flex-1' style={{ backgroundColor: '#77685F' }}>
      <View className='flex items-center' style={{ flex: 0.55 }}>
        {/* style={{ color: 'white', textAlign: 'center', marginTop: 30, fontSize: 20 }} */}
        <Text className=' text-[#FFE9D0] align-middle mt-28 text-[60px] font-medium'>
          Bon Apetit!
        </Text>
      </View>
